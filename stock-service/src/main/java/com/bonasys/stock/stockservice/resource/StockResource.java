package com.bonasys.stock.stockservice.resource;
...
public class StockResource {
	...
	@GetMapping("/{username}")
	public List<Quote> getQuote(@PathVariable("username")
										 final String username){
											
		//List quotes = restTemplate.getForObject("http://localhost:8300/rest/db/"+username, List.class);
